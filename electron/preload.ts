...
import { PRODUCTS } from './channels/products.channels'
import { SALES } from './channels/sales.channels'
import { SETTINGS } from './channels/settings.channels'
import { SYSTEM } from './channels/system.channels'
...
const api = {
  products: {
    ...
    lookupBarcode: (barcode: string) => ipcRenderer.invoke(PRODUCTS.LOOKUP_BARCODE, barcode),
  },
  ...
  sales: {
    ...
    dailySummary: (date: string) => ipcRenderer.invoke(SALES.DAILY_SUMMARY, date),
