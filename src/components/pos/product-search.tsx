...
export const ProductSearch = ({ onSelect, cartQuantities, refreshKey }: Props) => {
            ...
            return (
              ...
              >
                ...
                <div className="flex w-full items-center justify-between gap-2">
                  ...
                  {remaining <= 0 ? (
                    <Badge variant="destructive" className="text-[10px]">{t('products.stockOut')}</Badge>
                  ) : remaining <= 5 ? (
                    <Badge variant="outline" className="border-amber-400 text-amber-600 text-[10px]">{remaining}</Badge>
                  ) : (
